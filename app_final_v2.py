...
# Mostrar resultado do session_state se existir
if st.session_state.prediction_result is not None and not predict_btn:
    ...
    lat        = result["lat"]
    lon        = result["lon"]
    # Redirecionar para o bloco de resultado
    predict_btn = True

if not predict_btn and st.session_state.prediction_result is None:
    # Estado inicial
